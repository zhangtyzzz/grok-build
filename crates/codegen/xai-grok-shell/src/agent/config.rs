...
"#,
    ...
    fn session_resolver_is_not_stamped_onto_third_party_samplers() {
        ...
        let mut third_party = ResolvedAuxModelSamplingConfig {
        ...
        assert!(
            third_party.config.bearer_resolver.is_none(),
            "a third-party endpoint must keep its resolved credential"
        );
        let mut first_party = ResolvedAuxModelSamplingConfig {
            config: SamplerConfig {
        ...
        assert!(
            first_party.config.bearer_resolver.is_some(),
