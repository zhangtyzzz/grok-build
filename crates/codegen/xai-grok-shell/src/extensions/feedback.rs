...
use crate::session::{
    ...
    CommentResponse, FeedbackContext, FeedbackDraftSendRequest, FeedbackOutcome,
...
/// A draft body reaches `parse_draft_send_request` as raw JSON. A legacy body is parsed and
/// validated here.
